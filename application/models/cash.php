...
class Cash extends Model
{
	...
	*/
	...
	{
			//$array = Array (  Array ( [item_no] => 0001 [item_name] => Iphone SE [unit_price] => 23.00 ) [1] => Array ( [item_no] => 0002 [item_name] => Rhea Alcohol [unit_price] => 23.00 ) );

		#$data = array('description' => 'My title');
		...
		$this->db->insert('sales', $data);
			...
			//print_r($array);
			//exit();
		//$this->db->insert_batch('s', $data);
	}
	function cmplete($array)
	{
			//$array = Array (  Array ( [item_no] => 0001 [item_name] => Iphone SE [unit_price] => 23.00 ) [1] => Array ( [item_no] => 0002 [item_name] => Rhea Alcohol [unit_price] => 23.00 ) );

		$data = array('description' => 'My title');

		$this->db->insert('sales_items', $array);
	...
	function get_all_items_by_category($category, $limit=10000, $offset=0)
	{
		$this->db->from('items');
