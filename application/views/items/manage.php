...
<div id="title_bar">
	...
	<div id="new_button">
		...
		"<button class='btn-warning btn btn-lg'>".$this->lang->line($controller_name.'_new')."</button>",
		array('class'=>'thickbox none','title'=>$this->lang->line($controller_name.'_new')));
		?>
		<?php echo anchor("$controller_name/excel_import/width:$form_width",
		"<button class='btn btn-warning btn-lg'>Excel Import</button>",
		array('class'=>'thickbox none','title'=>'Import Items from Excel'));
		?>
	</div>
</div>

<div id="titleTextImg" style="background-color:#eead7e;height:25px;position:relative;margin: 2px;font-weight: bold; border-radius: 10px; padding: 1px;">
	<div style="float:left;vertical-align:text-top; margin: 2px;">Search Options :</div>
...
<div id="search_filter_section" style="display: <?php echo isset($search_section_state)?  ( ($search_section_state)? 'block' : 'none') : 'none';?>;background-color:#ffc699; padding-left: 5px; border-radius: 5px; margin-bottom: 5px;">
...
<div id="table_action_header">
	<ul style="margin: 5px;">
		<li class="float_left"><button class="btn btn-warning btn-sm"><?php echo anchor("$controller_name/delete",$this->lang->line("common_delete"),array('id'=>'delete')); ?></button></li>
		<li class="float_left"><button class="btn btn-warning btn-sm"><?php echo anchor("$controller_name/bulk_edit/width:$form_width",$this->lang->line("items_bulk_edit"),array('id'=>'bulk_edit','title'=>$this->lang->line('items_edit_multiple_items'))); ?></button></li>
<!--		<li class="float_left"><span>--><?php //echo anchor("$controller_name/generate_barcodes",$this->lang->line("items_generate_barcodes"),array('id'=>'generate_barcodes', 'target' =>'_blank','title'=>$this->lang->line('items_generate_barcodes'))); ?><!--</span></li>-->
		...
		<input style="margin: 5px;" class="form-control" type="text" name ='search' id='search' placeholder="Search Item"/>
		</form>
		</li>
	</ul>
</div>
