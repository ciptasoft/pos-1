...
<div id="register_wrapper">
	...
	<?php echo form_dropdown('mode',$modes,$mode,'class="form-control" onchange="$(\'#mode_form\').submit();"'); ?>
	</form>
...
<div id="new_item_button_register" >
		...
		"<div><button class='btn btn-sm btn-warning'>".$this->lang->line('sales_new_item')."</button></div>",
...
else
{
	...
	?>
		...
		<td>
		<?php
        	echo form_input(array('name'=>'quantity','value'=>$item['quantity'],'size'=>'2', 'class'=>'form-control'));
		?>
		</td>
...
<div id="overall_sale">
	...
	else
	{
		...
		<?php echo form_input(array('class'=>'form-control', 'name'=>'supplier','id'=>'supplier','size'=>'30','value'=>$this->lang->line('recvs_start_typing_supplier_name')));?>
		</form>
		<div style="margin-top:5px;text-align:center;">
		<h3 style="margin: 5px 0 5px 0"><?php echo $this->lang->line('common_or'); ?></h3>
		<?php echo anchor("suppliers/view/-1/width:350",
		"<div class='small_button' style='margin:0 auto;'><button class='btn btn-sm btn-warning'>".$this->lang->line('recvs_new_supplier')."</button></div>",
