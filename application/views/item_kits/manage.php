...
<div id="table_action_header">
	<ul>
		<li class="float_left"><div style="margin: 3px;" class="glyphicon white glyphicon-hand-down"></div><button class="btn btn-sm btn-danger"><?php echo anchor("$controller_name/delete",$this->lang->line("common_delete"),array('id'=>'delete')); ?></button></li>
<!--		<li class="float_left"><span>--><?php //echo anchor("$controller_name/generate_barcodes",$this->lang->line("items_generate_barcodes"),array('id'=>'generate_barcodes', 'target' =>'_blank','title'=>$this->lang->line('items_generate_barcodes'))); ?><!--</span></li>-->
		...
		<input class="form-control" type="text" name ='search' id='search' placeholder="Search Item Kits"/>
		</form>
		</li>
	</ul>
</div>
