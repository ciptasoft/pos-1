...
<div id="menubar">
	<div id="logo">
		<img width="100px" height="100px" src="<?php echo base_url().'images/logo.png';?>" border="0" alt="" />
	</div>
...
<!--		<span style='font-size:8pt;'>--><?php //echo $this->lang->line('common_powered_by'); ?><!--</span>-->
		...
		<div id="menubar_navigation">
			...
			<div class="menu_item">
				...
				<img width="50px" height="50px" src="<?php echo base_url().'images/menubar/'.$module->module_id.'.png';?>" border="0" alt="Menubar Image" /></a><br />
